...
public class LightFlicker : MonoBehaviour
{
    ...
    [SerializeField]
    private Renderer flickeringRenderer;

    [SerializeField]
    private FlickerMode flickerMode;

    [SerializeField]
    private float lightIntensityMin = 1.25f;

    [SerializeField]
    private float lightIntensityMax = 2.25f;

    [SerializeField]
    private float flickerDuration = 0.075f;
